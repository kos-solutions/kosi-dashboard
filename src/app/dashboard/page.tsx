...
import { Sparkles, Palette, BrainCircuit, Image as ImageIcon, LayoutTemplate } from 'lucide-react' // ⭐ Icon nou
  ...
  const drawings = activities
    ...
    .map(act => {
      ...
      return {
        id: act.id,
        url: (data as any).url,
        template: (data as any).template || 'Liber', // ⭐ Preluăm șablonul
